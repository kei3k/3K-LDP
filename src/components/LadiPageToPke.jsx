    ...
    <div className="flex-1 flex flex-col p-6 overflow-y-auto bg-background">
      <div className="max-w-2xl mx-auto w-full space-y-6">
        <div className="text-center space-y-2">
          ...
          <h2 className="text-2xl font-bold">LadiPage → Webcake (.pke)</h2>
          <p className="text-muted-foreground text-sm">
            Nhập URL của trang LadiPage để tải mã nguồn HTML và chuyển đổi tự động thành file PKE (có thể import trực tiếp vào Webcake).
          </p>
        </div>
